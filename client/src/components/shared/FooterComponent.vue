    ...
    <div class="relative mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8 lg:pt-24">
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
          ...
          >
            Este sitio fue creado para brindar información esencial sobre libros: títulos, autores,
            sinopsis y más. Ideal para quienes buscan una referencia rápida y clara.
          </p>
        </div>
